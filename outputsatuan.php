        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#beranda" >Order Satuan <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
   ...
   <div class="form-group">
            ...
            <table>
				...
				<tr>
                    ...
                    <td> 
                      <a href=editordersatuan.php?namapelanggan=<?php echo $data['namapelanggan'];?>>Edit</a>
                    </td>
				</tr>
				<?php
					}
